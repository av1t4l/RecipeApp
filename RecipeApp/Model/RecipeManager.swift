...
struct RecipeManager{
    ...
    private mutating func makeDefaults(){
        ...
        let Method = [Step]
        let defRecipe1 = Recipe(title:"Pancakes", mealTypes: [MealType.breakfast], dietaryReqs:[DietaryReq.vegan], time:Time(time:10, unit:"m"), diff: Diff.Easy, serves:5, ingredients: Ings, method:Method, image: "pancakes")
        ...
        let Method2 = [Step2]
        let defRecipe2 = Recipe(title:"Peach Muesli", mealTypes: [MealType.breakfast], dietaryReqs:[DietaryReq.vegan], time:Time(time:10, unit:"m"), diff: Diff.Medium, serves:5, ingredients: Ings2, method:Method2, image: "muesli")
        ...
        let Method3 = [Step3]
        let defRecipe3 = Recipe(title:"Rock Cakes", mealTypes: [MealType.breakfast], dietaryReqs:[DietaryReq.vegan], time:Time(time:10, unit:"m"), diff: Diff.Hard, serves:5, ingredients: Ings3, method:Method3, image: "rock-cakes")
